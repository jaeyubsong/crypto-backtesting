...
class TestSymbolEnum:
    ...
    def test_should_have_correct_values(self):
        ...
        assert Symbol.BTC == "BTCUSDT"
        assert Symbol.ETH == "ETHUSDT"

    def test_should_convert_from_string_case_insensitive(self):
    ...
    def test_should_raise_error_for_invalid_symbol(self):
    ...
    def test_should_get_base_currency(self):
    ...
    def test_should_get_quote_currency(self):
...
class TestTimeframeEnum:
    ...
    def test_should_convert_to_seconds(self):
    ...
    def test_should_convert_from_string(self):
    ...
    def test_should_raise_error_for_invalid_timeframe(self):
    ...
    def test_should_check_if_intraday(self):
...
class TestTradingModeEnum:
    ...
    def test_should_have_correct_values(self):
        ...
        assert TradingMode.MARGIN == "margin"

    def test_should_validate_leverage_for_spot(self):
    ...
    def test_should_validate_leverage_for_futures(self):
    ...
    def test_should_validate_leverage_for_margin(self):
    ...
    def test_should_get_default_leverage(self):
    ...
    def test_should_get_max_leverage(self):
    ...
    def test_should_check_if_requires_margin(self):
    ...
    def test_should_get_default_maintenance_margin_rate(self):
...
class TestActionTypeEnum:
    ...
    def test_should_have_correct_values(self):
        ...
        assert ActionType.LIQUIDATION == "liquidation"

    def test_should_check_if_opening(self):
    ...
    def test_should_check_if_closing(self):
    ...
    def test_should_check_if_forced(self):
    ...
    def test_should_get_created_position_type(self):
