...
class TestBacktestException:
    ...
    def test_should_create_base_exception_with_message(self):
...
class TestValidationError:
    ...
    def test_should_create_validation_error_with_message(self):
    ...
    def test_should_handle_field_specific_validation(self):
...
class TestDataError:
    ...
    def test_should_create_data_error_with_message(self):
        """Test creating data error."""
        exc = DataError("Failed to load CSV file")
        assert str(exc) == "Failed to load CSV file"
        assert isinstance(exc, BacktestException)

    def test_should_handle_file_path_in_message(self):
...
class TestInsufficientFundsError:
    ...
    def test_should_create_insufficient_funds_error(self):
    ...
    def test_should_format_error_message_correctly(self):
    ...
    def test_should_handle_zero_available_funds(self):
...
class TestPositionNotFoundError:
    ...
    def test_should_create_position_not_found_error(self):
    ...
    def test_should_format_error_message_with_symbol(self):
    ...
    def test_should_handle_various_symbol_formats(self):
...
class TestInvalidLeverageError:
    ...
    def test_should_create_invalid_leverage_error(self):
    ...
    def test_should_format_error_message_with_details(self):
    ...
    def test_should_handle_spot_trading_leverage(self):
...
class TestLiquidationError:
    ...
    def test_should_create_liquidation_error(self):
    ...
    def test_should_format_error_message_with_position_details(self):
    ...
    def test_should_handle_short_position_liquidation(self):
